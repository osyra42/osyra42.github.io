...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const linksData = [
        ...
        { section: 'Navigation', href: 'changelog.html', text: 'Changelog', icon: 'changelog.png', alt: 'Changelog', title: 'Click to see the changelog', updateDate: 20260131 },
        ...
        { section: 'Navigation', href: 'how_magnets_work.html', text: 'How Magnets Work', icon: 'floppy-disk.png', alt: 'Magnets', title: 'Learn how to use magnet links for torrenting', updateDate: 20260131 },
        { section: 'Navigation', href: 'comfyui_guide.html', text: 'ComfyUI Guide', icon: 'wand-magic-sparkles.png', alt: 'ComfyUI', title: 'Learn how to use ComfyUI for AI image generation', updateDate: 20260131 },
        ...
        { section: 'Projects', href: 'archived.html', text: 'Archives', icon: 'file-pdf.png', alt: 'Archives', title: 'Click to view archived documents', updateDate: 20260131 },
