...
<div class="project-links">
  ...
  <a title="Click to view bugs or submit a bug report" href="backrooms/bug_tracker.html" class="nav-link"
...
<div class="pth">
  <div>
    <hr />
    <a target="_blank" href="legal/privacy_policy.txt" class="nav-link pth-link"><i class="fas fa-shield-alt"></i> Privacy</a> |
    <a target="_blank" href="legal/terms_of_service.txt" class="nav-link pth-link"><i class="fas fa-gavel"></i> Terms</a> |
    <a target="_blank" href="legal/help_and_faq.txt" class="nav-link pth-link"><i class="fas fa-question-circle"></i> Help</a>
  </div>
</div>
`;
